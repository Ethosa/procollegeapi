...
BAD_WORDS = compile(
    (
        ...
        r'|конча|малафья|ссыкло|мудень|обмудень|ебанутый|ебанько|тварина|падла|сучара|нацизм|ркн|блядюга|'
        r'|целка|хуяк|хуями|хули|хуйло|хуепутало|хуюшки|'
        r'|(вз)?дрочн?[уи]ть|[ао]хереть|(до|за)?пиздеть|клитор|вагина|очко|минет|наебалово|наебщик|'
        r'|мудозвон|мудоеб|педик|пидрила|петушара|лошара|ебанат|трахать|шмара|шалава|шлюхоеб|уебан|долбоебина|шлюхан|'
